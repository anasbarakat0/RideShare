...
class UpdateToFinishedModel {}

class UpdatedToFinished extends UpdateToFinishedModel {
  ...
  UpdatedToFinished copyWith({
    String? message,
    String? status,
    String? localDateTime,
    Body? body,
  }) {
    return UpdatedToFinished(
  ...
  factory UpdatedToFinished.fromMap(Map<String, dynamic> map) {
    return UpdatedToFinished(
  ...
  factory UpdatedToFinished.fromJson(String source) =>
      UpdatedToFinished.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'UpdatedToFinished(message: $message, status: $status, localDateTime: $localDateTime, body: $body)';
  }

  @override
  bool operator ==(covariant UpdatedToFinished other) {
...
class ExceptionRequest extends UpdateToFinishedModel {
